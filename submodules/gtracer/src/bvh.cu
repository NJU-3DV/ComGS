...
public:
	TriangleBvh(){
		...
		m_optix.gaussiantrace_forward = std::make_unique<optix::Program<Gaussiantrace_forward>>(
			(const char*)optix_ptx::gaussiantrace_forward_ptx, sizeof(optix_ptx::gaussiantrace_forward_ptx), g_optix);
		m_optix.gaussiantrace_backward = std::make_unique<optix::Program<Gaussiantrace_backward>>(
			(const char*)optix_ptx::gaussiantrace_backward_ptx, sizeof(optix_ptx::gaussiantrace_backward_ptx), g_optix);
